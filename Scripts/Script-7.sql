...
SELECT * FROM FILE_TABLE ft WHERE FILE_ID =1200;
SELECT * FROM POST_TABLE pt WHERE POST_ID=1200;
...
SELECT * FROM POST_TABLE pt WHERE POST_ID =104;
SELECT * FROM MM_TABLE mt WHERE MM_ID =101;
